...
var Uploader = function (_Component) {
  ...
  function Uploader(props) {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                files.forEach(function (file) {
                  var f = new File([file.originFileObj], uniqid(), {
                  ...
                  if (!_this.uploadingFiles[file.id]) {
                    ...
                    file.loading = true;
                    _this.uploadingFiles[file.id] = new S3Upload(options);
                  }
                });
                _this.setState({
                  loading: true,
    ...
    _this.abortAllUploads = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return forEach(_this.uploadingFiles, function (item) {
    ...
    _this.checkLoadings = function (items) {
      var m = map(items, function (item) {
        return item;
      });
      var l = some(m, { loading: true });
      var s = every(m, { saved: true });
    ...
    _this.deleteItem = function (item) {
      ...
      var i = findIndex(fields, { id: item.id });
      delete fields[i];
      //we need to compact array to avoid empty fields
      var compactFields = compact(fields);
    ...
    _this.itemListRender = function (item) {
      ...
      return React.createElement(ItemUpload, {
        key: item.id,
        item: item,
        active: isActive,
        value: value,
  ...
  Uploader.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        maybeContentOverride = _props.contentOverride,
    ...
    var contentOverride = maybeContentOverride;
    if (contentOverride && typeof contentOverride === "function") {
      contentOverride = contentOverride({ uploading: uploading, loading: loading });
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        _extends({
          ...
          onDrop: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(acceptedFiles, rejectedFiles) {
              var fileNames, cleanedFileList, keepGoing, responses;
              return _regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      if (rejectedFiles.length) {
                        fileNames = rejectedFiles.map(function (f) {
                          return f.name;
                        });

                        window.toastr && window.toastr.warning("This uploader accepts " + acceptToUse + ". These files were rejected because they                 do not have the proper extension: " + fileNames.join(", "));
                      }
                    ...
                    case 28:
                      ...
                      return Promise.all(acceptedFiles.map(function (fileToUpload) {
                        ...
                        return axios.post(action, data).then(function (res) {
                          responses.push(res.data && res.data[0]);
                          onFileSuccess(res.data[0]).then(function () {
                            cleanedFileList = cleanedFileList.map(function (file) {
                              var fileToReturn = _extends({}, file, res.data[0]);
      ...
      fileList && showUploadList && !!fileList.length && React.createElement(
        ...
        fileList.map(function (file, index) {
          ...
          return fileListItemRenderer ? fileListItemRenderer(file, self) : S3Params ? _this3.itemListRender(file, self) : React.createElement(
            "div",
