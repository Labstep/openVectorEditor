...
var TgSelect = (_temp2 = _class = function (_React$Component) {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      return React.createElement(
        ...
        { //we specifically don't use a BP MenuItem component here because the menu item is too slow when 100s are loaded and will cause the component to lag
          ...
          key: index,
          className: classNames("tg-select-option bp3-menu-item bp3-fill bp3-text-overflow-ellipsis", {
      ...
      var filteredVals = filter(value, function (obj, i) {
        return !isEqual(i, tagProps["data-tag-index"]);
      });
      e.stopPropagation();
      ...
      if (multi) {
        ...
        var filteredVals = filter(value, function (obj) {
          return !isEqual(obj.value, item.value);
        });
      ...
      _this.setState({
        ...
        isCreateNewItem || _this.props.creatable ? getCreateNewItem() : null)
      });
  ...
  TgSelect.prototype.render = function render() {
    ...
    var rightElement = isLoading ? React.createElement(Button, { loading: true, minimal: true }) : React.createElement(
      "span",
      null,
    ...
    return React.createElement(MultiSelect, _extends({
...
var noResultsDefault = React.createElement(
  "div",
  null,
  "No Results..."
);

export var renderCreateNewOption = function renderCreateNewOption(query, active, handleClick) {
...
export var singleItemPredicate = function singleItemPredicate(queryString, item, isSimpleSearch) {
  return (isSimpleSearch ? simplesearch : fuzzysearch)(queryString.toLowerCase(), item.label ? item.label.toLowerCase ? item.label.toLowerCase() : getTextFromEl(item.label, { lowerCase: true }) : item.value && item.value.toLowerCase && item.value.toLowerCase() || "");
};
