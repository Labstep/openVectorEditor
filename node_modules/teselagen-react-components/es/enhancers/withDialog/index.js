...
export default function withDialog(topLevelDialogProps) {
    ...
    return function (_React$Component) {
      ...
      DialogWrapper.prototype.render = function render() {
        ...
        var _props2 = this.props,
            ...
            onCloseHook = _props2.onCloseHook,
            dialogProps = _props2.dialogProps,
            title = _props2.title,
            isDraggable = _props2.isDraggable,
            alreadyRendering = _props2.alreadyRendering,
            rest = _objectWithoutProperties(_props2, ["target", "noTarget", "isDialogOpen", "showModal", "dialogName", "onClickRename", "hideModal", "fetchPolicy", "children", "onCloseHook", "dialogProps", "title", "isDraggable", "alreadyRendering"]);

        var extraDialogProps = _extends({}, topLevelDialogProps, dialogProps);
        var _onCloseHook = onCloseHook || extraDialogProps.onCloseHook;
        ...
        //   );
        var DialogToUse = isDraggable || extraDialogProps.isDraggable ? ResizableDraggableDialog : Dialog;
        return React.createElement(
          ...
          targetEl && React.cloneElement(targetEl, (_React$cloneElement = {}, _React$cloneElement[onClickRename || "onClick"] = function (e) {
            showModal();
  ...
  return compose(connect(function (_ref) {
    var tg_modalState = _ref.tg_modalState;

    return _extends({}, topLevelDialogProps, { tg_modalState: tg_modalState });
  }), lifecycle({
