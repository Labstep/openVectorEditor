...
import { Button, Checkbox, Menu, MenuItem, Classes, InputGroup, Popover, Switch } from "@blueprintjs/core";
...
var DisplayOptions = function (_React$Component) {
  ...
  function DisplayOptions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props$updateTab = _this.props.updateTableDisplayDensity,
          updateTableDisplayDensity = _this$props$updateTab === undefined ? noop : _this$props$updateTab;
  ...
  DisplayOptions.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        updateColumnVisibility = _props$updateColumnVi === undefined ? noop : _props$updateColumnVi,
        _props$resetDefaultVi = _props.resetDefaultVisibility,
        resetDefaultVisibility = _props$resetDefaultVi === undefined ? noop : _props$resetDefaultVi,
        compact = _props.compact,
        extraCompact = _props.extraCompact,
    ...
    if (!isEmpty(fieldGroups)) {
      fieldGroupMenu = map(fieldGroups, function (groupFields, groupName) {
      ...
      Popover,
      {
        ...
        content: React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: Classes.SELECT + " tg-table-display-density" },
              React.createElement(
                "select",
                {
                  onChange: this.changeTableDensity,
                  value: extraCompact ? "extraCompact" : compact ? "compact" : "normal"
                },
                React.createElement(
                  "option",
                  { className: Classes.POPOVER_DISMISS, value: "normal" },
                  "Comfortable"
                ),
                React.createElement(
                  "option",
                  { className: Classes.POPOVER_DISMISS, value: "compact" },
                  "Normal"
                ),
                React.createElement(
                  "option",
            ...
            hasOptionForForcedHidden && React.createElement(
              "div",
              { style: { marginTop: 15 } },
...
export { DisplayOptions as default };