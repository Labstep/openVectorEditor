...
var schemas = {
  j5PcrReactions: {
    fields: [{ path: "id", type: "number", displayName: "PCR ID" },
  ...
  j5OligoSyntheses: {
    fields: [{ path: "id", type: "string", displayName: "Oligo ID" }, { path: "name", type: "string", displayName: "Oligo Name" }, {
    ...
    }, { path: "tm", type: "number", displayName: "Tm (°C)" }, { path: "tm3Prime", type: "number", displayName: "Tm 3' Only (°C)" }, {
  ...
  j5AssemblyPieces: {
    fields: [{ path: "id", type: "string", displayName: "Piece ID" }, { path: "name", type: "string", displayName: "Name" }, { path: "type", type: "string", displayName: "Source" }, {
  ...
  j5RunConstructs: {
    fields: [{ path: "id", type: "string", displayName: "Construct ID" }, { path: "name", type: "string", displayName: "Construct Name" }, { path: "sequence.size", type: "number", displayName: "Length (bp)" }, {
  ...
  j5InputSequences: {
    ...
    }, { path: "sequence.name", type: "string", displayName: "Name" }, { path: "sequence.size", type: "number", displayName: "Length (bp)" }, { path: "inStock", type: "boolean", displayName: "In Stock" }, {
      path: "sequence.polynucleotideMaterialId",
      type: "boolean",
      displayName: "Is Linked"
    }]
  ...
  j5DirectSyntheses: {
    ...
    { path: "inStock", type: "boolean", displayName: "In Stock" }, {
      ...
      type: "boolean",
      displayName: "Is Linked"
    }, { path: "sequence.size", type: "number", displayName: "Length (bp)" }, { path: "cost", type: "number", displayName: "Cost (USD)" }]
  },
  j5InputParts: {
    fields: [{
