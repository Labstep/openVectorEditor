...
var dateMinMaxHelpers = {
  minDate: (0, _moment2.default)().subtract(25, "years").toDate(),
  maxDate: (0, _moment2.default)().add(25, "years").toDate()
};
    ...
    switch (filterType) {
      ...
      case "date":
        inputGroup = _react2.default.createElement(
          ...
          }, (0, _getMomentFormatter2.default)("MM/DD/YYYY"), dateMinMaxHelpers, {
