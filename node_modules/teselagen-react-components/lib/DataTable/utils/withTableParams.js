...
function withTableParams(compOrOpts, pTopLevelOpts) {
  ...
  var mapStateToProps = function mapStateToProps(state, ownProps) {
    ...
    var history = mergedOpts.history,
        ...
        withPaging = mergedOpts.withPaging,
        doNotCoercePageSize = mergedOpts.doNotCoercePageSize,
        ...
        _mergedOpts$additiona2 = mergedOpts.additionalOrFilter,
        additionalOrFilter = _mergedOpts$additiona2 === undefined ? {} : _mergedOpts$additiona2,
        noOrderError = mergedOpts.noOrderError,
        withDisplayOptions = mergedOpts.withDisplayOptions,
        cellRenderer = mergedOpts.cellRenderer,
        model = mergedOpts.model,
        isCodeModel = mergedOpts.isCodeModel,
        noForm = mergedOpts.noForm;
    ...
    var selectedEntities = withSelectedEntities ? (0, _withSelectedEntities.getRecordsFromReduxForm)(state, formName) : undefined;

    var additionalFilterToUse = typeof additionalFilter === "function" ? additionalFilter.bind(_this, ownProps) : function () {
      return additionalFilter;
    };
    var additionalOrFilterToUse = typeof additionalOrFilter === "function" ? additionalOrFilter.bind(_this, ownProps) : function () {
      return additionalOrFilter;
    };
    var mapStateProps = _extends({
      history: history,
      ...
      doNotCoercePageSize: doNotCoercePageSize,
      additionalFilter: additionalFilter,
      additionalOrFilter: additionalOrFilter,
  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    ...
    function updateSearch(val) {
      setTimeout(function () {
        dispatch((0, _reduxForm.change)(formName, "reduxFormSearchInput", val || ""));
      });
    }
    ...
    return {
      bindThese: (0, _queryParams.makeDataTableHandlers)({
  ...
  function mergeProps(stateProps, dispatchProps, ownProps) {
    ...
    Object.keys(dispatchProps.bindThese).forEach(function (key) {
      var action = dispatchProps.bindThese[key];
    ...
    var changeFormValue = function changeFormValue() {
      for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }

      return dispatchProps.dispatch(_reduxForm.change.apply(undefined, [formName].concat(args)));
    };

    var tableParams = _extends({
    ...
    var allMergedProps = _extends({}, ownProps, {
