...
(0, _recompose.withProps)(function (ownProps) {
  ...
  var _propsToUse = propsToUse,
      ...
      _propsToUse$compact = _propsToUse.compact,
      compact = _propsToUse$compact === undefined ? true : _propsToUse$compact,
      extraCompact = _propsToUse.extraCompact;
  ...
  var compactToUse = !!compact;
  var extraCompactToUse = !!extraCompact;
  ...
  if (withDisplayOptions) {
    ...
    if (columnOrderings) {
      ...
      schemaToUse.fields = fieldsWithOrders.sort(function (_ref, _ref2) {
        var path1 = _ref.path;
...
(0, _reduxForm.formValues)("localStorageForceUpdate", "reduxFormQueryParams", "reduxFormSearchInput", "reduxFormSelectedEntityIdMap", "reduxFormExpandedEntityIdMap"),
// withFields({
//   names: [
