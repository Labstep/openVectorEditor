...
var _rerenderOnWindowResize = require("./rerenderOnWindowResize");

var _rerenderOnWindowResize2 = _interopRequireDefault(_rerenderOnWindowResize);

require("./FillWindow.css");
...
var FillWindow = function (_React$Component) {
  ...
  function FillWindow(props) {
    ...
    (0, _rerenderOnWindowResize2.default)(_this);
    return _this;
  }
  ...
  FillWindow.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      this.props.children && (0, _lodash.isFunction)(this.props.children) ? this.props.children(windowDimensions) : this.props.children
    );
  };
