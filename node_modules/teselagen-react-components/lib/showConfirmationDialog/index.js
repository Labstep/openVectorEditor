...
exports.default = showConfirmationDialog;
...
function showConfirmationDialog(opts) {
  return new Promise(function (resolve) {
    (0, _renderOnDoc.renderOnDoc)(function (handleClose) {
      return _react2.default.createElement(AlertWrapper, _extends({}, opts, { handleClose: handleClose, resolve: resolve }));
    });
  });
}
...
var AlertWrapper = function (_Component) {
  ...
  AlertWrapper.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        intent = _props$intent === undefined ? _core.Intent.PRIMARY : _props$intent,
        rest = _objectWithoutProperties(_props, ["handleClose", "text", "resolve", "content", "cancelButtonText", "intent"]);
    ...
    return _react2.default.createElement(
      ...
      _extends({
        ...
        onCancel: cancelButtonText ? function () {
