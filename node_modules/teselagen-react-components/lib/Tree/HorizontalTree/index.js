...
var HorizontalTree = (_temp2 = _class = function (_React$Component) {
  ...
  function HorizontalTree() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      return !!children.length && !isMinimap && _react2.default.createElement(
        "div",
        {
          style: (_ref2 = {
            position: "absolute",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _core.Tooltip,
            { content: isCollapsed ? "Expand node" : "Collapse node" },
            _react2.default.createElement(
              "span",
              null,
              isCollapsed ? "+" : "-"
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          !!collapsedNodes[nodeId] && _react2.default.createElement(
            "div",
            {
              style: {
                width: "100%",
          ...
          _react2.default.createElement(
            ...
            children.map(function (child, i) {
              return _react2.default.createElement(
                "div",
                {
                  key: (0, _lodash.get)(child, cardIdKey),
                  style: {
      ...
      return _react2.default.createElement(
        ...
        _extends({}, (0, _lodash.pick)(_this.props, ["minimapViewportSelector", "minimapParentSelector", "minimapThickness", "zoom"]), {
          rootRef: rootRef,
          isHorizontal: true
        }),
  ...
  HorizontalTree.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
...
HorizontalTree.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  spaceBetweenSiblings: _propTypes2.default.number.isRequired,

  /**
   * The vertical space, in pixels, between levels.
   */
  yOffsetPerUnitDepth: _propTypes2.default.number.isRequired
} : {};
