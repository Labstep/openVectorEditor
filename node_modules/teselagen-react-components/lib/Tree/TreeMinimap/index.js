...
var Minimap = (_temp2 = _class = function (_React$PureComponent) {
  ...
  function Minimap() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.state = {
      ...
      var _this3 = _this,
          lastMinimapViewportMouseX = _this3.lastMinimapViewportMouseX,
          lastMinimapViewportMouseY = _this3.lastMinimapViewportMouseY;
  ...
  Minimap.prototype.componentDidMount = function componentDidMount() {
    ...
    window.addEventListener("mousemove", this.handleMinimapViewportMouseMove, false);
    window.addEventListener("mouseup", this.handleMinimapViewportMouseUp, false);
    window.addEventListener("mousemove", this.handleMinimapBackgroundMouseMove, false);
    window.addEventListener("mouseup", this.handleMinimapBackgroundMouseUp, false);
  ...
  Minimap.prototype.componentWillUnmount = function componentWillUnmount() {
    ...
    document.body.removeEventListener("mousemove", this.handleMinimapViewportMouseMove, false);
    document.body.removeEventListener("mouseup", this.handleMinimapViewportMouseUp, false);
    document.body.removeEventListener("mousemove", this.handleMinimapBackgroundMouseMove, false);
    document.body.removeEventListener("mouseup", this.handleMinimapBackgroundMouseUp, false);
