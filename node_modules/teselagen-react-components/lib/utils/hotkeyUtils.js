...
exports.withHotkeys = exports.getHotkeyProps = exports.hotkeysById = undefined;
...
function comboToLabel(def) {
  ...
  if (useSymbols) {
    ...
    parts = parts.map(function (p) {
      return symbols[p] || (0, _lodash.startCase)(p) || p;
    });
    return parts.join("");
  } else {
    return combo.split("+").map(function (p) {
      return (0, _lodash.startCase)(p) || p;
    }).join(" + ").replace("Meta", isMac ? "Cmd" : "Ctrl").replace("Mod", isMac ? "Cmd" : "Ctrl").replace("Alt", isMac ? "Option" : "Alt");
  }
}

// HOF to get hotkey combos by id
var hotkeysById = exports.hotkeysById = function hotkeysById(hotkeys) {
...
var getHotkeyProps = exports.getHotkeyProps = function getHotkeyProps(def, id) {
  var out = void 0;
  ...
  out.label = out.label || (0, _lodash.startCase)(id);
  return out;
};
...
var withHotkeys = function withHotkeys(hotkeys, handlers) {
  ...
  return function (Component) {
      ...
      Sub.prototype.renderHotkeys = function renderHotkeys() {
        ...
        return _react2.default.createElement(
          ...
          Object.keys(hotkeys).map(function (id) {
            ...
            return _react2.default.createElement(_core.Hotkey, _extends({}, props, {
              key: id,
    ...
    return (0, _core.HotkeysTarget)(Sub);
  };
};
