...
exports.default = function (nameOrFragment) {
  var _handlers;
  ...
  var recordType = (0, _pascalCase2.default)(name);
  // const pluralRecordType = pluralize(recordType);
  /*eslint-disable*/
  var deleteByIdsMutation = (0, _graphqlTag2.default)(_templateObject, recordType, recordType, recordType);
  /*eslint-enable*/
  ...
  var deleteHelper = function deleteHelper(props) {
    return function () {
  ...
  }, _handlers[(0, _lodash.camelCase)("delete_" + recordType)] = deleteHelper, _handlers);
  if (mutationName) {
    handlers[mutationName] = deleteHelper;
  }

  return (0, _recompose.compose)((0, _reactApollo.graphql)(deleteByIdsMutation, _extends({}, rest)), (0, _recompose.withHandlers)(handlers));
};
...
function prepareArgs(args) {
  ...
  var input = idArray.map(function (id) {
    ...
    return _ref = {}, _ref[isCode ? "code" : "id"] = id, _ref;
  });
  return {
    input: input,
    idArray: idArray,
...
var afterDeleteFunction = function afterDeleteFunction(_ref2) {
  var idArray = _ref2.idArray,
