...
function DeletionLayers(props) {
  ...
  return _react2.default.createElement(
    ...
    deletionLayersToUse.sort(function (deletionLayer) {
      ...
      var color = deletionLayer.color;

      var overlaps = (0, _veRangeUtils.getOverlapsOfPotentiallyCircularRanges)(deletionLayer, row, sequenceLength);
      return overlaps.map(function (overlap) {
        ...
        return [_react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            rangeSpansSequence && deletionStart && _react2.default.createElement("rect", {
              fill: "blue",
              x: "0",
              y: "0",
              height: deletionLineHeight,
            ...
            rangeSpansSequence && deletionEnd && _react2.default.createElement("rect", {
              fill: "blue",
              x: width - 4,
              y: "0",
              height: deletionLineHeight,
...
exports.default = (0, _pureNoFunc2.default)(DeletionLayers);
