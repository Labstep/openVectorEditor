...
exports.deleteTranslation = exports._upsertTranslation = undefined;
...
// Actions
// ------------------------------------
var _upsertTranslation = exports._upsertTranslation = (0, _createMetaAction2.default)("UPSERT_TRANSLATION");
...
// Reducer
// ------------------------------------
exports.default = (0, _reduxAct.createReducer)(_extends({}, (0, _upsertDeleteActionGenerator2.default)(_upsertTranslation, deleteTranslation)), defaultValue);