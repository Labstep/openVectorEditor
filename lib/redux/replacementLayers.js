...
// Reducer
// ------------------------------------
exports.default = (0, _reduxAct.createReducer)((_createReducer = {}, _defineProperty(_createReducer, replacementLayerClear, function () {
  return {};
}), _defineProperty(_createReducer, replacementLayerUpdate, function (state, payload) {
  return _extends({}, state, _defineProperty({}, payload.id, _extends({
    color: (0, _randomcolor2.default)({ hue: "green", luminosity: "dark" }),
    id: payload.id
  }, payload.range)));
}), _defineProperty(_createReducer, replacementLayerDelete, function (state, payload) {
